...
<head>
    ...
    {!!$code[0]->facebook_comments!!}
    
</head>
<body>
<div id="cover"></div>
<div class="theme2">
    <div class="row" style="background-color: #e4bb87;">
        <div class="pull-left gologo">
            <a href="http://ashtavinayaksoftsolution.in/"><img class="img-responsive" src="{{ URL::asset('assets/images/logo')}}/{{$settings[0]->logo}}" alt="Lawyer Directory"></a>
        </div>
