                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                <li class="active"><a href="#socials" data-toggle="tab" aria-expanded="true">Google Analytics</a>
                                <li><a href="#comments" data-toggle="tab" aria-expanded="false">Facebook Comments Script</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane" id="comments">
                            <p class="lead">Facebook Comments</p>
                            <div class="ln_solid"></div>
                            <form method="POST" action="{!! action('SocialLinkController@comment') !!}" id="meta_form" class="form-horizontal form-label-left" novalidate>
                                {{csrf_field()}}
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meta_keys"> Facebook Comments Script <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <textarea rows="10" class="form-control" name="facebook_comments" placeholder="Copy and Paste facebook comment SDK code." required="required">{{$tools->facebook_comments}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <button type="submit" class="btn btn-success btn-block">Update Facebook Comments</button>
                                    </div>
                                </div>
                            </form>
                        </div>
