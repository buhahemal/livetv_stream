                            ...
                            <div id="typeoption">
                                ...
                                @else
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <img src="{!! url('/') !!}/assets/images/ads/{{$ad->banner_file}}" style="max-height: 600px;max-width: 728px;" alt="No Banner Photo">
                                        </div>
                                    </div>
                                    <div class="item form-group">
